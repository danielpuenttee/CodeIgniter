...
<div id="filtros">
    ...
    <?php
    echo form_open(RUTA_ADMINISTRACION . '/vehiculos/buscar', 'post');
    ...
    <button type="button" onclick="window.location.href='<?=site_url(RUTA_ADMINISTRACION . '/vehiculos/resetear')?>'">Resetear filtros</button>
...
<div id="dropdown">
    <?php
    echo form_open(RUTA_ADMINISTRACION . '/vehiculos/listado/', array('id' => 'miFormulario', 'method' => 'post'));
...
<div id="nuevo_vehiculo">
    <?php
    echo form_open(RUTA_ADMINISTRACION . '/vehiculos/ficha/0', array('id' => 'btnCancelar', 'method' => 'get'));
    $submit_attributes = array(
        'name' => 'btSubmit',
        'id' => 'btSubmit',
        'class' => 'boton',
